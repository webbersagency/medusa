---
sidebar_label: "Multi-Part Product"
---
...
You create a product with multi-part variants as explained in the [Create Product](../page.mdx) guide. For the variants with multi-parts, you enable the "Has inventory kit" toggle in the "Variants" step.
